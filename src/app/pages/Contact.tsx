...
export function Contact() {
  ...
  const inputClasses = "w-full px-4 py-3 bg-rofe-white border border-rofe-cream text-rofe-basalt focus:outline-none focus:ring-1 focus:ring-rofe-basalt placeholder:text-rofe-drift";
      ...
      <section className="py-20 px-6 sm:px-8 lg:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            {/* Contact Information */}
            <div>
              <h2 className="text-2xl mb-10 text-rofe-basalt tracking-[0.04em]" style={{ fontWeight: 200 }}>
                Contact Information
              </h2>
              ...
              <div className="space-y-8 mb-14">
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <h3 className="text-sm text-rofe-basalt mb-1 tracking-[0.05em]" style={{ fontWeight: 300 }}>Email</h3>
                    <a href="mailto:hello@rofeliving.com" className="text-rofe-ash hover:text-rofe-basalt transition-colors text-sm" style={{ fontWeight: 300 }}>
                      hello@rofeliving.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-5">
                  <div className="w-10 h-10 bg-rofe-warm flex items-center justify-center flex-shrink-0">
                    <Phone className="w-4 h-4 text-rofe-ash" />
                  </div>
                  <div>
                    <h3 className="text-sm text-rofe-basalt mb-1 tracking-[0.05em]" style={{ fontWeight: 300 }}>Phone</h3>
                    <a href="tel:+34123456789" className="text-rofe-ash hover:text-rofe-basalt transition-colors text-sm" style={{ fontWeight: 300 }}>
                      +34 123 456 789
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <h3 className="text-sm text-rofe-basalt mb-1 tracking-[0.05em]" style={{ fontWeight: 300 }}>Location</h3>
              ...
              <div className="mb-14">
                <h3 className="text-xs uppercase tracking-[0.2em] text-rofe-drift mb-4" style={{ fontWeight: 300 }}>Follow Us</h3>
              ...
              <div className="p-8 bg-rofe-warm">
                <h3 className="text-sm text-rofe-basalt mb-4 tracking-[0.05em]" style={{ fontWeight: 300 }}>Office Hours</h3>
                <div className="space-y-2 text-rofe-ash text-sm" style={{ fontWeight: 300 }}>
                  <p>Monday – Friday: 9:00 AM – 8:00 PM</p>
                  <p>Saturday: 10:00 AM – 6:00 PM</p>
                  <p>Sunday: 10:00 AM – 4:00 PM</p>
                </div>
                <p className="mt-4 text-xs text-rofe-drift tracking-[0.05em]" style={{ fontWeight: 300 }}>
                  24/7 emergency support available for guests
                </p>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="loft-vulcano">Loft Vulcano</option>
                  </select>
                </div>
                ...
                <div>
                  <label htmlFor="guests" className={labelClasses} style={{ fontWeight: 300 }}>
                    Number of Guests
                  </label>
                  <select
                    id="guests"
